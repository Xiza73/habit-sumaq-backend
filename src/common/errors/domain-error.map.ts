...
export const DOMAIN_HTTP_MAP: Record<ErrorCodeKey, number> = {
  ...
  REMINDER_NOT_FOUND: HttpStatus.NOT_FOUND,
  REMINDER_BELONGS_TO_OTHER_USER: HttpStatus.FORBIDDEN,
  REMINDER_TITLE_REQUIRED: HttpStatus.UNPROCESSABLE_ENTITY,
  REMINDER_TITLE_TOO_LONG: HttpStatus.UNPROCESSABLE_ENTITY,
  REMINDER_NOTES_TOO_LONG: HttpStatus.UNPROCESSABLE_ENTITY,
  REMINDER_DATE_INVALID: HttpStatus.UNPROCESSABLE_ENTITY,
  REMINDER_TIME_INVALID: HttpStatus.UNPROCESSABLE_ENTITY,
  REMINDER_TIME_WITHOUT_DATE: HttpStatus.UNPROCESSABLE_ENTITY,
  ...
  CHORE_NO_LOGS_TO_REVERT: HttpStatus.CONFLICT,
  ...
  DEBT_LOAN_NO_PENDING_FOR_REFERENCE: HttpStatus.NOT_FOUND,
