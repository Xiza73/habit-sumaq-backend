export const ERROR_CODES = {
  ...
  NO_STREAK_SHIELDS: 'HAB_007',
  NO_RESCUABLE_PERIOD: 'HAB_008',
  NO_RESCUE_FOR_PERIOD: 'HAB_009',
  ...
  // Reminders (one-shot, optionally dated and timed)
  REMINDER_NOT_FOUND: 'RMDR_001',
  REMINDER_BELONGS_TO_OTHER_USER: 'RMDR_002',
  REMINDER_TITLE_REQUIRED: 'RMDR_003',
  REMINDER_TITLE_TOO_LONG: 'RMDR_004',
  REMINDER_NOTES_TOO_LONG: 'RMDR_005',
  REMINDER_DATE_INVALID: 'RMDR_006',
  REMINDER_TIME_INVALID: 'RMDR_007',
  REMINDER_TIME_WITHOUT_DATE: 'RMDR_008',
  // Monthly services
