...
- (Opcional) `GIT_COMMIT_SHA` — fallback vendor-neutral. Si algún día migras a otro hosting (Fly, Render, VPS), setéala manualmente desde el CI/build con el SHA del commit. El endpoint la lee como secundaria.
